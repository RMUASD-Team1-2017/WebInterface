...
class DroneMission(models.Model):
    ...
    waypoint_longtitude = models.FloatField(null = True, blank=True)
    waypoint_latitude = models.FloatField(null = True, blank=True)
    goal_longtitude = models.FloatField(null = True, default = None, blank=True)
    goal_latitude = models.FloatField(null = True, default = None, blank=True)
    call_longtitude = models.FloatField(null = True, default = None, blank=True)
